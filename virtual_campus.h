...
public:
	...
	/* Parameterized constructor
		*/
	Seminars(string _coordinator, string _speaker, string _date, int _max_seats, string* _list_students_s, int _size, Resources _status, Resources _id[7]);
		/* Copy constructor string _status, char _id[7], 
			*/
...
class Projects : public Resources {
	public:
		...
		/* Parameterized constructor
			*/
		Projects(string _tutor, bool _co_tutor_presence, string _co_tutor, Resources _status, Resources _id[7]);
		/* Copy constructor
			*/
...
class Courses : public Resources {
	public:
		...
		/* Parameterized constructor
			*/
		Courses(int _credits, string* _list_students, float* _list_marks, int _size_students, int _size_marks, Resources _status, Resources _id[7]);
		/* Copy constructor
			*/
...
class Professor : public Users{
	public:
		...
		/* Parameterized constructor
			*/
		Professor(char _pid[7], Users _name);
		/* Copy constructor
			*/
...
class Student : public Users{
	public:
		...
		/* Parameterized constructor
			*/
		Student(int _sin[7], string* _list_courses, string* _list_sem, string* _list_project, int _size_courses, int _size_sems, int _size_projects, Users _name);
		/* Copy constructor
			*/
